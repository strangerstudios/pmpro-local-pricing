...
<!-- Usage questions can also be directed to Paid Memberships Pro: (https://www.paidmembershipspro.com/support/), unless this is a question about a premium extension, in which case you should use the helpdesk. -->
...
- [ ] This bug happens with only Paid Memberships Pro plugin and Paid Memberships Pro - Local Pricing active
