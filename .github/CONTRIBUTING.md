# Contribute to Paid Memberships Pro - Local Pricing

Paid Memberships Pro - Local Pricing is the "community solution" for membership sites on WordPress, and so contributions of all kinds are appreciated.
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-local-pricing/issues/new/choose)
...
* Make sure to pull in any "upstream" changes first.
	* Use `git remote add upstream https://github.com/strangerstudios/pmpro-local-pricing.git` to set the upstream repo
...
* Finally, please use tabs and not spaces. The tab indent size should be 4 for all Paid Memberships Pro - Local Pricing code.
